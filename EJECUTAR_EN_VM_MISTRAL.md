# 🚀 Configurar Moltbot con Mistral (Ejecutar en la VM)

## ✅ Verificación Inicial

Ya verificaste que la conectividad funciona:
```bash
curl http://192.168.100.42:11436/api/tags  # ✓ Funciona
```
...
- ✅ Una respuesta del modelo Mistral

## 🔄 Cambiar a Qwen

Si quieres probar Qwen después, solo cambia:
- Puerto: `11436` → `11437`
- Modelo: `mistral` → `qwen2.5:7b`
- URL: `http://192.168.100.42:11436/v1` → `http://192.168.100.42:11437/v1`

## 🐛 Troubleshooting

**Error: "Failed to discover Ollama models"**
- Verifica: `curl http://192.168.100.42:11436/v1/models`
- Debe devolver JSON con los modelos

**Error: "Invalid URL"**
- Verifica que la URL tenga `/v1` al final
- No debe haber espacios extra

**Error: "does not support tools"**
- Mistral debería soportar tools
- Si persiste, verifica que el modelo esté correctamente descargado en el contenedor
